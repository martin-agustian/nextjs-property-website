...
export default function About() {
  return (
    <Section id="about" className="bg-[#F1F6FD] py-10" animationClass="about">
      <div className="container flex flex-col lg:flex-row gap-10 xl:gap-14 items-center">
        <div id="segment-1" className="w-full">
        ...
        <div id="segment-2" className="block">
          ...
          <ButtonPill id="segment-2-1" dotId="segment-2-2" className="h-[48px] md:h-[52px] w-[247px] md:w-[255px] bg-[#2B3F7D] mt-10 md:mt-16" textClassName="text-white">
