...
export default function Footer() {
  return (
    <footer className="bg-mirage text-white py-10">
        ...
        <div className="flex gap-16 md:gap-10 lg:gap-5 flex-col md:flex-row text-center md:text-left">
          <div className="md:flex-3 order-1">
            <div className="text-[24px] lg:text-[28px] font-manrope font-[600] leading-[120%] mt-5">
              Stay informed about the <span className="text-mariner">latest property opportunities</span>
            </div>

            <div className="relative md:inline-block mt-5">
              <input placeholder="benoitmacke@car" className="h-[40px] lg:h-[48px] w-[100%] md:w-[374px] bg-white text-black placeholder:text-cadet-grey rounded-full pl-3 pr-11" />

              <div className="size-[32px] flex items-center justify-center absolute top-[50%] translate-[-50%] right-[-10px] bg-tropical-blue rounded-full">
          ...
          <ul className="md:flex-1 flex flex-col gap-3 text-[14px] font-[500] leading-[150%] capitalize order-2 md:order-3">
            <li className="cursor-pointer hover:text-dark-pastel-blue">service</li>
